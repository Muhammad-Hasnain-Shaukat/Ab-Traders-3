  ...
  return (
    <div className="pt-24 pb-16 sm:pt-28 sm:pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        {/* Story */}
        <div className="lg:col-span-7 space-y-6 text-sm text-[#586956] leading-relaxed">
          <p>
          ...
          <div className="pt-4 grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-[#D7E3D4]">
            <div className="p-4 bg-white border border-[#D7E3D4] rounded-xl shadow-inner">
              <Award className="w-5 h-5 text-[#5C8358] mb-2" />
              <h4 className="font-serif text-sm font-semibold text-white">Quality Checked</h4>
              <p className="text-xs text-[#586956] mt-1">Leak & thread checked before final dispatch.</p>
            </div>

            <div className="p-4 bg-white border border-[#D7E3D4] rounded-xl shadow-inner">
              <Layers className="w-5 h-5 text-[#5C8358] mb-2" />
              <h4 className="font-serif text-sm font-semibold text-white">Broad Range</h4>
              <p className="text-xs text-[#586956] mt-1">Glass, PET, HDPE, and specialized closures.</p>
            </div>

            <div className="p-4 bg-white border border-[#D7E3D4] rounded-xl shadow-inner">
              <ShieldCheck className="w-5 h-5 text-[#5C8358] mb-2" />
              <h4 className="font-serif text-sm font-semibold text-white">Direct Logistics</h4>
              <p className="text-xs text-[#586956] mt-1">Safe transit packaging to any city in Pakistan.</p>
            </div>
          </div>
        </div>

        {/* Operational Overview Card */}
        <div className="lg:col-span-5 bg-white border border-[#D7E3D4] rounded-2xl p-6 sm:p-8 shadow-2xl space-y-6">
          ...
          <div className="space-y-4 text-xs sm:text-sm">
            <div className="flex items-start gap-3">
              <MapPin className="w-5 h-5 text-[#5C8358] shrink-0 mt-0.5" />
              <div>
                <p className="font-semibold text-white">Commercial Hub & Shop</p>
                <p className="text-[#586956] leading-relaxed">Shop # 2604/D, Papar Mandi Naya Bazar, Near Niween Masjid, Shah Alam Market, Lahore</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <Phone className="w-5 h-5 text-[#5C8358] shrink-0 mt-0.5" />
              <div>
                <p className="font-semibold text-white">Direct Contacts (Ramiz Qaiser)</p>
                <a href="tel:03278822358" className="text-[#586956] hover:text-[#5C8358] block">
                  0327-8822358 / 0322-5080132
                </a>
                <a href="tel:04237364617" className="text-[#586956] hover:text-[#5C8358] block">
                  PTCL: 042-37364617
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Clock className="w-5 h-5 text-[#5C8358] shrink-0 mt-0.5" />
              <div>
                <p className="font-semibold text-white">Operating Hours</p>
                <p className="text-[#586956] leading-relaxed">Monday – Saturday: 9:00 AM – 7:00 PM PKT</p>
              </div>
            </div>
          </div>

          <div className="pt-4 border-t border-[#D7E3D4]">
            <Link
              to="/quote"
              className="w-full inline-flex items-center justify-center gap-2 bg-[#5C8358] hover:bg-[#4F724B] text-white text-xs font-bold py-3.5 px-4 rounded-lg shadow-lg shadow-[#5C8358]/20 transition-all"
            >
